      ...
      <td>
        {row.name ? (
          <Form.Group as={Col} md="12">
            <Form.Control required readOnly type="text" value={row.name} />
          </Form.Group>
        ) : (
          <Form.Group as={Col} md="12">
            <Form.Select
...
export default QuotationRevise_old;
